...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_TOG_VIM] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_CAPS, _VIM),
    [TD_TOG_BASE] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_ESC, _VIM),
};
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_BASE] = LAYOUT(
        ...
        LT(_MACRO, KC_GRV),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_HOME,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_END,
        TD(TD_TOG_VIM), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGUP,
...
//     ),
    ...
    [_VIM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        TD(TD_TOG_BASE), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),
...
// #endif // COLEMAK_LAYER_ENABLE
    ...
    void encoder_action_rgbsaturation(bool clockwise) {
        if (clockwise)
    ...
    bool encoder_update_user(uint8_t index, bool clockwise) {
        ...
        if (mods_state & MOD_BIT(KC_LSFT) ) { // If you are holding L shift, encoder changes layers
            ...
            encoder_action_rgbsaturation(clockwise);
